...
import { FaApple, FaEnvelope, FaGlobe, FaHandPeace, FaInstagram } from 'react-icons/fa';
import {
  IoSearchSharp,
...
export default function MacToolbar({
  ...
  const menus: Record<string, MenuItem[]> = {
    ...
    //         action: () => window.scrollTo({ top: 6, behavior: 'smooth' }),
    //       },
    //       {
    //         label: 'Experience',
    ...
    Go: [
      ...
      },
      {
        ...
        action: () => window.open(userConfig.social.instagram, '_blank'),
            
        },
      {
        label: 'About The Creator',
        icon: <FaHandPeace size={16} />,
        action: () => window.open(userConfig.social.creatorresume, '_blank'),
      },
    ],
    Help: [
      {
        ...
        <div className='flex items-center space-x-4' ref={menuRef}>
          ...
          <div className="relative">
            <span 
              ...
              onMouseEnter={() => setShowSignature(false)}
